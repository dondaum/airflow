...
class TestDag:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param("on_success_callback", True, id="on_success_callback_with_callback_type"),
            pytest.param("on_failure_callback", True, id="on_failure_callback_with_callback_type"),
        ],
    )
    @conf_vars(
        {
