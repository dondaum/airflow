...
from airflow.providers.apprise.version_compat import get_async_connection
...
class TestGetAsyncConnection:
    @mock.patch("airflow.providers.apprise.version_compat.BaseHook", new_callable=MockAgetBaseHook)
    @pytest.mark.asyncio
    ...
    @mock.patch("airflow.providers.apprise.version_compat.BaseHook", new_callable=MockBaseHook)
    @pytest.mark.asyncio
